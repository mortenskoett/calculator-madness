...
type CalculationServiceClient interface {
	Run(ctx context.Context, in *RunCalculationRequest, opts ...grpc.CallOption) (*RunCalculationResponse, error)
}
...
func (c *calculationServiceClient) Run(ctx context.Context, in *RunCalculationRequest, opts ...grpc.CallOption) (*RunCalculationResponse, error) {
	out := new(RunCalculationResponse)
	err := c.cc.Invoke(ctx, "/calculator.CalculationService/Run", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CalculationServiceServer interface {
	Run(context.Context, *RunCalculationRequest) (*RunCalculationResponse, error)
...
func (UnimplementedCalculationServiceServer) Run(context.Context, *RunCalculationRequest) (*RunCalculationResponse, error) {
...
func _CalculationService_Run_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RunCalculationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CalculationServiceServer).Run(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/calculator.CalculationService/Run",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculationServiceServer).Run(ctx, req.(*RunCalculationRequest))
	}
...
var CalculationService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Run",
			Handler:    _CalculationService_Run_Handler,
		},
	},
